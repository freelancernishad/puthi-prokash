                        ...
                        <tbody>
                            <tr v-for="(list,index) in lists" :key="index">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" @click="DeleteAction('Are you sure?','Delete this multimedia',`/api/multimedia/${list.id}`,'Multimedia Deleted',getLists)">Delete</button>
...
export default {
    ...
    methods: {
        async getLists(page=1){
            ...
            var res = await this.callApiPaginate(`/api/multimedia?page=${page}`,page);
            // console.log(res)
            this.lists = res
